 ...
 */
public class SendSMSData extends AsyncTask<Void,Void,String>
{
    private JSONObject list;

    private StringBuilder sb = new StringBuilder();

    private String url = "http://192.168.49.240:3000/messages";

    public SendSMSData(JSONObject jsonObject)
    {
        list=jsonObject;
